...
logger = logging.getLogger(
    "toolops.generation.test_case_generation.test_case_generation_utils.combination_modules.mandatory_optional_param_testcase"
)


# This method generates testcases using all mandatory paramteres and a combination of subset of optional parameters #
def mandatory_optional_param_testcase(
    ...
    while number_testcases_to_generate_more > 0:
        total_tries_made_to_generate_testcase = (
            total_tries_made_to_generate_testcase + 1
        )
        ...
        while incorrectly_generated_data:
            try:
                ...
                for case in data_generated_through_LLM_so_far:
                    ...
                    data_generated_through_LLM_with_mandatory_and_some_optional_param[
                    ...
                    if count_testcases == original_number_of_testcases_to_generate_more:
                        ...
                        break
                number_testcases_to_generate_more = (
                    original_number_of_testcases_to_generate_more - count_testcases
                )
                ...
                incorrectly_generated_data = True
    logger.info(
        "Testcases generated with all mandatory and some optional parameters",
        extra={
            "details": data_generated_through_LLM_with_mandatory_and_some_optional_param
        },
    )
