...
def generate_tool_description_via_code(
    ...
    responses = execute_prompt(
        prompt_gen_str,
        client=enrichment_config.tool_llm_config.llm_client,
        gen_mode=enrichment_config.tool_llm_config.gen_mode,
        parameters=None,
...
def gen_tool_input_examples_via_code(
    ...
    if (
        ...
        params_dict["max_new_tokens"] = enrichment_config.tool_llm_config.llm_config[
            "default"
        ]["tool_example_generation"]["max_new_tokens"]
        params_dict["stop_sequences"] = enrichment_config.tool_llm_config.llm_config[
            "default"
        ]["tool_example_generation"]["stop_sequences"]
    else:
        params_dict["max_new_tokens"] = enrichment_config.tool_llm_config.llm_config[
            "default"
        ]["max_new_tokens"]
